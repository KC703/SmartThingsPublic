/**
 *
 *  zooZ ZSE40 4-in-1 Motion Sensor (Advanced)
 *   
 *	github: Kenneth Chen (KC703)
 *	email: ken.c.chen@gmail.com
 *	Date: 2016-10-09
 *	Copyright Kenneth Chen
 *
 *  Utilized code from Eric Maycock, just set Motion as primary tile
 *
 ...
 */
 ...
 metadata {
	definition (name: "zooZ ZSE40 4-in-1 Sensor (Advanced) MOTION", namespace: "KC703", author: "KC") {
